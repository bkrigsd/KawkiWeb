...
-- =====================================================
-- SP_REPORTE_VENTAS_Y_TENDENCIAS
-- Reporte de rendimiento de ventas y tendencias de productos
-- =====================================================
USE KAWKI_DB;
DELIMITER $$

DROP PROCEDURE IF EXISTS SP_REPORTE_VENTAS_Y_TENDENCIAS$$
...
-- =====================================================
-- SP_REPORTE_ESTADO_STOCK
-- Reporte de estado de stock y productos en riesgo
-- =====================================================
USE KAWKI_DB;
DELIMITER $$

DROP PROCEDURE IF EXISTS SP_REPORTE_ESTADO_STOCK$$
