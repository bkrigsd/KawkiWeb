...
-- -----------------------------------------------------
-- Table `KAWKI_DB`.`REDES_SOCIALES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `KAWKI_DB`.`REDES_SOCIALES` (
  `RED_SOCIAL_ID` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `KAWKI_DB`.`VENTAS` (
  ...
  INDEX `FK_VENTAS_REDES_SOCIALES` (`RED_SOCIAL_ID` ASC) VISIBLE,
  ...
  CONSTRAINT `FK_VENTAS_DESCUENTOS`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_VENTAS_REDES_SOCIALES`
    FOREIGN KEY (`RED_SOCIAL_ID`)
    REFERENCES `KAWKI_DB`.`REDES_SOCIALES` (`RED_SOCIAL_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
CREATE TABLE IF NOT EXISTS `KAWKI_DB`.`PRODUCTOS` (
  ...
  INDEX `FK_PRODUCTOS_USUARIOS` (`USUARIO_ID` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `KAWKI_DB`.`PRODUCTOS_VARIANTES` (
  ...
  INDEX `FK_PRODUCTOS_VARIANTES_USUARIOS` (`USUARIO_ID` ASC) VISIBLE,
  ...
  CONSTRAINT `FK_PRODUCTOS_VARIANTES_TALLAS`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_PRODUCTOS_VARIANTES_USUARIOS`
    FOREIGN KEY (`USUARIO_ID`)
    REFERENCES `KAWKI_DB`.`USUARIOS` (`USUARIO_ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
