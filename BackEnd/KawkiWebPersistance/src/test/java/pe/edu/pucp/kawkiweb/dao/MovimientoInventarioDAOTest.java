...
//    
//    public MovimientoInventarioDAOTest() {
...
//        this.prodVarianteDTO = prodVarianteDTO;
//    }
//    
//    @Test
...
//        this.insertarMovimientosInventario(listaMovInventariosId);
//        
//        MovimientoInventarioDTO movInventarioDTO = this.movInventarioDAO.obtenerPorId(listaMovInventariosId.get(0));
...
//        this.insertarMovimientosInventario(listaMovInventariosId);
//        
//        ArrayList<MovimientoInventarioDTO> listaMovInventarios = this.movInventarioDAO.listarTodos();
...
//        ArrayList<MovimientoInventarioDTO> listaMovInventarios = this.movInventarioDAO.listarTodos();
//        for(MovimientoInventarioDTO usuario : listaMovInventarios){
//            Integer resultado = this.movInventarioDAO.eliminar(usuario);
//            assertNotEquals(0,resultado);
//            MovimientoInventarioDTO movInventarioDTO = this.movInventarioDAO.obtenerPorId(usuario.getMov_inventario_id());
